            ...
            public void onClick(View v) {
                ...
                for (int j = 0; j < 10; j++) {
                    if(oneonesubject[j].getBytes().length <= 0){
                        ...
                        totalcredit += oneonecreditnum[j];} // 총이수학 점 계산 (분모용)
                    totalcreditShow += oneonecreditnum[j]; //총 이수학점 계산
                ...
                for (int j = 0; j < 10; j++) {
                    if(oneonecheck[j].isChecked()) {
                        ...
                        totalEnggradesumM += (oneonegradeEng[j]) * (oneonecreditnum[j]);
                    }
                }
                totalKorgrade = totalKorgradesum/totalcredit; //4.5 만점 평점
                totalEnggrade = totalEnggradesum/totalcredit; //4.0 만점 평점
                MajorKor = totalKorgradesumM/totalcreditM;
                MajorEng = totalEnggradesumM/totalcreditM;
                ...
                TextView Majorgradeview1 = findViewById(R.id.Majorgradeview1Kor);
                TextView Majorgradeview2 = findViewById(R.id.Majorgradeview1Eng);
                ...
                Majorgradeview1.setText(String.format(Locale.getDefault(),"%.3f",MajorKor));
                Majorgradeview2.setText(String.format(Locale.getDefault(),"%.3f",MajorEng));
